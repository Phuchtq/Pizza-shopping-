...
public class SaveCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            cart = (HashMap<String, Product>) session.getAttribute(sessionName);
            CartUtil cartUtils = new CartUtil();
            if (cart != null) {
                String strItemsInCart = cartUtils.convertCartToString(new ArrayList<Product>(cart.values()));
                cartUtils.saveCartToCookie(request, response, strItemsInCart, accountId);
                msg = "Your Cart has been saved successfully.";
            }
        } catch (Exception e) {
            log("SaveCartServlet has error: " + e.getMessage());
        } finally {
